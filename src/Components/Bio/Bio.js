...
function Bio(){
  return(
    <div className="bioBox" id="bio">
      ...
      <p className='robotoRegular paragraphText'>Hi, I'm George. I'm a software developer who's passionate about building sustainable, flexible software. In my spare time I do improv comedy and nerd out about Comp Sci history.</p>
      <ul>
